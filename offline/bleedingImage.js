modelfilestrs['bleedingImage'] = hereDoc(function(){/*!
	...
	var bleedingImage = new function() {
		...
		this.init = function() {
			...
			if (x_currentPageXML.getAttribute("link") != undefined && x_currentPageXML.getAttribute("link") != "") {
				...
				$panel.append('<a href="' + x_currentPageXML.getAttribute("link") + '" target="' + target + '" id="linkImgA"><img src="' + x_templateLocation + 'common_html5/linkicon.png" alt="' + tooltip + '" id="linkImg" />' + linkWarning + '</a>');
